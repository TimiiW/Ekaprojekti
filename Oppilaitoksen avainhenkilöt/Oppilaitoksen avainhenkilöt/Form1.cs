...
namespace Oppilaitoksen_avainhenkilöt
{
    public partial class Avainhenkilotform : Form
    {
        ...
        {
            taytaoppilaitostualukko();
            taytavastuuhenkilottualukko();
            OppilaitosCB.DataSource = oppilaitos;
            OppilaitosCB.DisplayMember = "ONimi";
        }

        private void taytaoppilaitostualukko()
        {
         ...
         private void taytavastuuhenkilottualukko()
        {
            ...
            vastuuHenkilot.Rows.Add(2, "Riikka-Maria Yli-Suomu", "Liiketoimintajohtaja", "Elinvoima- ja tyällisyyspalvelut", "riikka-maria.yli-suomu@omnia.fi", "050 348 6544");
            ...
            vastuuHenkilot.Rows.Add(3, "Anne Heinonen", "Tyäelämäpalvelupäällikkä", "", "anne.heinonen@vantaa.fi", "040 524 1242");
            vastuuHenkilot.Rows.Add(3, "Tuula Kiistinen", "Yhteisten palveluiden päällikkä", "", "tuula.kiiskinen@vantaa.fi", "040 193 9048");
            ...
            vastuuHenkilot.Rows.Add(4, "Hanna Nyränen", "Viestintä- ja markkinointipäällikkö", "Viestintäpalvelut", "hanna.nyronen@keuda.fi", "040 521 8428");
